...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <div class="product container">
          <div class="row" style=>
              <div class="">
              @foreach($productsale as $key => $values)
                      ...
                      <div class="col-md-3 p-2" style="float: left; width:230px; height:300px;   ">
                          ...
                          <a href="">
                              ...
                              <div class="card w-100 h-100" >
                                  <img src="{{ asset('image/product/' . $values->product->image) }}"
                                  class="d-block w-100" style="height:180px"
                                      alt="{{ $values->product->image }}">
          
                                  <div  class="p-2" style="font-size: .85rem; height:100px">
                                      <p class="product h-50" >{{ $values->product->name }}</p>
                                      
                                          <p class="fs-7">
                                              <b>
                              <span class="strikethrough text-dark">{{ $values->product->price }}đ</span><span class="text-danger"> - {{ $values->pricesale }}đ</span> 
                                             </b>
                                              </p>
                                  </div>
                              </div>
