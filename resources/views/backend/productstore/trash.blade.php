                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center" >
                                <img src="{{asset('image/productstore/' .$value->product->image)}}" height="100" width="80" alt="">
                            </td>
                            ...
                            <td class="text-center">
                               ...
                               <a href="{{route('productstore.restore', [$value->id])}}" class="btn btn-sm btn-primary">
                                <i class="fas fa-undo"></i>
                                </a>
                                <a href="{{route('productstore.destroy', [$value->id])}}" class="btn btn-sm btn-danger">
