    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <strong class="">THÊM TRANG ĐƠN</strong>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="row">
                        <div class="col md-9">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="metadesc"  value="{{old('metadesc')}}" id="metadesc" class="form-control" required placeholder="Mô tả bài viết"></textarea>
                            </div>
                         
                            <div class="mb-3">
                                <label for="detail">Chi tiết</label>
                                <textarea name="detail"  value="{{old('detail')}}" id="detail" class="form-control" required placeholder="Chi tiết bài viết"></textarea>
                            </div>
