...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <strong class="fs-3">THÙNG RÁC SẢN PHẨM KHUYẾN MÃI</strong>
                </div>
                <div class="col-sm-6">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                               ...
                               <a href="{{route('productsale.restore', [$value->id])}}" class="btn btn-sm btn-primary">
                                <i class="fas fa-undo"></i>
                                </a>
                                <a href="{{route('productsale.destroy', [$value->id])}}" class="btn btn-sm btn-danger">
