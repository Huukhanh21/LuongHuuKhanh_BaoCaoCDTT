                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <div class="mb-3">
                                ...
                                <input name="name" id="name" value="{{$banner->name}}"  type="text" class="form-control" required
                                    placeholder="Nhập tên banner">
                            </div>
                           
                            <div class="mb-3">
                                <label for="link">Link</label>
                                <input name="link" value="{{$banner->link}}"  id="link" type="text" class="form-control">
                            </div>
                            <div class="mb-3">
                                <label for="metadesc">Mô tả</label>
                                <textarea name="metadesc" id="metadesc" 
                                class="form-control" rows="3" required
                                    placeholder="">{{$banner->metadesc}}</textarea>
                            </div>
                            <div class="mb-3">
